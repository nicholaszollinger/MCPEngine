...
namespace mcp
{
    ...
    //		NOTES:
    //		
    ///		@brief : Get the position of the mouse relative to this Window.
    //-----------------------------------------------------------------------------------------------------------------------------
    Vec2 WindowBase::GetMousePosition()
    {
        return GetWindow<WindowType>().GetMousePosition();
    }

    //-----------------------------------------------------------------------------------------------------------------------------
    //		NOTES:
    //		
    ///		@brief : Send an ApplicationEvent to the window.
    //-----------------------------------------------------------------------------------------------------------------------------
    void WindowBase::PostApplicationEvent(ApplicationEvent& event)
    {
        GetWindow<WindowType>().PostApplicationEvent(event);
    }
